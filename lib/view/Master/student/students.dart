...
import 'package:tr_app/view/Master/student/student_tile.dart';
...
class StudentnsList extends StatelessWidget {
  final ValueNotifier<TextDirection> _textDir =
      ValueNotifier(TextDirection.ltr);
  String type;
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey();

  StudentnsList(this.type);
  var studentcontroller = Get.put(StudentsnController(EndPointMaster.getStudentByname));
  @override
