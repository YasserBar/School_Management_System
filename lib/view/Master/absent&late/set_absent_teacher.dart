...
class Absenteacher extends StatelessWidget {
  ...
  Absenteacher({Key? key}) : super(key: key);
  var controller = Get.put(SetAbsentController("employee_id",EndPointMaster.setAbsenceOrLateEm));
          ...
          children: <Widget>[
            ...
            Obx(() {
              ...
              return MaterialButton(
                ...
                child:
                    const Text("Submet", style: TextStyle(color: primaryColorS)),
              );
            }),
          ],
        ),
